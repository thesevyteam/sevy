  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center">
        <div className="text-center mb-5 w-3/5">
        ...
        <div className="flex items-center justify-between mb-5 w-3/5">
        ...
        <form className="w-4/5 md:w-3/5" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <>
              <Button
                text={'Sign In'}
                onClick={() => submitElement.current.click()}
                icon={<RiLoginCircleFill style={{ width: 16, height: 16 }} />}
              />
              <button
                type="submit"
                className="hidden"
